function [data] = MPC_run(window_info, line_parameters, color_values, Trials_num, Run_num, Pathway, USE_BIOPAC, USE_EYELINK, dofmri, data, GUI_table_data)  
...
%% Trial start
data = MPC_trial(window_info, line_parameters, color_values, Trials_num, Run_num, Pathway, data, GUI_table_data);
