...
for sub_j = 1:numel(subjects)
    ...
    multi_nuisance_matfilenames{1} = fullfile(nuisance_dir, sprintf('nuisance_run%02d.mat', 1));
    multi_nuisance_matfilenames{2} = fullfile(nuisance_dir, sprintf('nuisance_run%02d.mat', 2));
    multi_nuisance_matfilenames{3} = fullfile(nuisance_dir, sprintf('nuisance_run%02d.mat', 4));
    multi_nuisance_matfilenames{4} = fullfile(nuisance_dir, sprintf('nuisance_run%02d.mat', 5));
    multi_nuisance_matfilenames{5} = fullfile(nuisance_dir, sprintf('nuisance_run%02d.mat', 6));
